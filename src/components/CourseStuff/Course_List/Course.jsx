...
import { Box, Input, Button, Grid, Select, FormControl, FormLabel, SimpleGrid, Flex, Text, Divider, Textarea, Spinner, useToast } from '@chakra-ui/react';
...
export default function EditableCourseDetails() {
    ...
    return (
        <Box mb={5} mr={5} ml={5} mt={5} bg="white" boxShadow="md" p="4" borderRadius="md" w={{ base: '100%', md: '75%' }} overflow="auto" css={{
            '&::-webkit-scrollbar': {
                width: '8px',
                height: '8px',
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
                ...
                <FormControl>
                    ...
                    <Input
                        ...
                        onChange={(e) => handleInputChange(e, 'overAllRating')}
                        readOnly={!isEditable}
                        bg={isEditable ? 'white' : 'gray.100'}
                    />
                </FormControl>
